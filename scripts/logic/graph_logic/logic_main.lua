...
manual_labyrinthofrefraincovenofdusk_ishmael_location = {}
manual_labyrinthofrefraincovenofdusk_ishmael_location.__index = manual_labyrinthofrefraincovenofdusk_ishmael_location
...
---@type table<string, manual_labyrinthofrefraincovenofdusk_ishmael_new_return>
NAMED_LOCATIONS = {}
local stale = true
...
---@class manual_labyrinthofrefraincovenofdusk_ishmael_new_return
...
---@field name string
---@field side string?
---@field exits table<integer, {[1]:manual_labyrinthofrefraincovenofdusk_ishmael_new_return, [2]:fun(): accessibilityLevel}>
---@field keys integer
...
---@param name string
---@return manual_labyrinthofrefraincovenofdusk_ishmael_new_return
function manual_labyrinthofrefraincovenofdusk_ishmael_location.new(name)
	if name == nil then
		error("manual_labyrinthofrefraincovenofdusk_ishmael_location name cannot be nil")
	end
	if NAMED_LOCATIONS[name] then
		print("manual_labyrinthofrefraincovenofdusk_ishmael_location " .. name .. " already exists")
	end
    local self = setmetatable({}, manual_labyrinthofrefraincovenofdusk_ishmael_location)
	self.name = name
...
---@param exit string|manual_labyrinthofrefraincovenofdusk_ishmael_new_return manual_labyrinthofrefraincovenofdusk_ishmael_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function manual_labyrinthofrefraincovenofdusk_ishmael_location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        ...
        if existing then
            ...
            exit = manual_labyrinthofrefraincovenofdusk_ishmael_location.new(exit)
        end
    end
    if rule == nil then
        rule = always
...
---@param exit string|manual_labyrinthofrefraincovenofdusk_ishmael_new_return manual_labyrinthofrefraincovenofdusk_ishmael_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function manual_labyrinthofrefraincovenofdusk_ishmael_location:connect_two_ways(exit, rule)
...
---@param exit string|manual_labyrinthofrefraincovenofdusk_ishmael_new_return manual_labyrinthofrefraincovenofdusk_ishmael_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function manual_labyrinthofrefraincovenofdusk_ishmael_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
---@param exit string|manual_labyrinthofrefraincovenofdusk_ishmael_new_return manual_labyrinthofrefraincovenofdusk_ishmael_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function manual_labyrinthofrefraincovenofdusk_ishmael_location:connect_two_ways_entrance(name, exit, rule)
...
function manual_labyrinthofrefraincovenofdusk_ishmael_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
---@param rule1? fun(): accessibilityLevel|boolean
---@param rule2? fun(): accessibilityLevel|boolean
function manual_labyrinthofrefraincovenofdusk_ishmael_location:connect_two_ways_stuck(exit, rule1, rule2)
...
---@return accessibilityLevel
function manual_labyrinthofrefraincovenofdusk_ishmael_location:accessibility()
...
---@param keys integer
function manual_labyrinthofrefraincovenofdusk_ishmael_location:discover(accessibility, keys)
...
Entry_Point = manual_labyrinthofrefraincovenofdusk_ishmael_location.new("Entry_Point")
