...
function canReachAstromEast()
    return ALL(canReachAstromSouth(),HAS("stockpilexp",1),HAS("progressiveastrom",2))
end
...
function canReachAstromNorth()
    return ALL(ANY(HAS("userfoffensively",1),HAS("userfdefensively",1)),HAS("progressiveastrom",4))
end
